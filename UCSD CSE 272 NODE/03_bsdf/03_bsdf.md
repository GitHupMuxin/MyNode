...
![image-20264154659671.png](image/image-20264154659671.png)
![image-20264155016670.png](image/image-20264155016670.png)
## 各项同性BRDF和各项异性BRDF
各项同行BRDF将4D的函数降为到了3D（因为对于某一入射光源，反射光源分布是对称的）。而各项异性则保持4D的复杂度
!![image-20264155340340.png](image/image-20264155340340.png)
## 互易性
...
!![image-20264154249407.png](image/image-20264154249407.png)
**假设各向同性**：忽略方位角变化。
!![image-20264154310948.png](image/image-20264154310948.png)
**自适应参数化**：根据粗糙度缩放采样区域（Dupuy & Jakob 2018）。
!![image-20264154553259.png](image/image-20264154553259.png)
#### 经典数据集
...
!![image-20264155121733.png|697](image/image-20264155121733.png)
...
$$
其中 $\eta ,\  \eta'$为折射率
!![image-2026415287743.png](image/image-2026415287743.png)
Cook-Torrance 方法在某些程度上与MERL测量得效果十分相似
!![image-20264152931211.png](image/image-20264152931211.png)
但对于微表面模型有其限制：
难以模拟蝴蝶翅膀的结构色、复杂的雾状各向异性等现象。
同时，只考虑了一次弹射
因此会造成能量损失
!![image-20264153214155.png](image/image-20264153214155.png)
